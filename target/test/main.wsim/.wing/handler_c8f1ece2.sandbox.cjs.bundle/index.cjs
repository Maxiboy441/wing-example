...
var require_inflight_Closure2_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure2-1.cjs"(exports2, module2) {
    ...
    module2.exports = function({ $expect_Util, $queue, $redis, $util_Util }) {
      class $Closure2 {
        static {
        ...
        async handle() {
          ...
          await $util_Util.waitUntil(async () => {
            return $helpers.neq(await $redis.get("hello"), void 0);
          });
          await $expect_Util.equal(await $redis.get("hello"), "world!");
        }
      }
      return $Closure2;
    };
...
// ../../../../usr/local/lib/node_modules/winglang/node_modules/@winglang/sdk/lib/expect/assert.js
var require_assert = __commonJS({
  "../../../../usr/local/lib/node_modules/winglang/node_modules/@winglang/sdk/lib/expect/assert.js"(exports2) {
    "use strict";
    var __createBinding2 = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
...
// target/test/main.wsim/.wing/handler_c8f1ece2.sandbox.cjs
var $handler = void 0;
