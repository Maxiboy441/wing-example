...
var require_inflight_Closure5_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure5-1.cjs"(exports2, module2) {
    ...
    module2.exports = function({ $api_url, $expect_Util, $http_HttpMethod, $http_Util, $std_Json }) {
      class $Closure5 {
        static {
        ...
        async handle() {
          ...
          await $expect_Util.equal(((obj, key) => {
            if (!(key in obj))
...
// target/test/main.wsim/.wing/handler_c88bd96a.sandbox.cjs
var $handler = void 0;
