...
exports.handler = async function(event) {
  ...
  handler: 
          ...
          require("/Volumes/data/private/winglang-tut/target/test/main.wsim/.wing/inflight.$Closure1-1.cjs")({
            $counter: (function() {
  let handle = process.env.COUNTER_HANDLE_f1709696;
  if (!handle) {
    throw new Error("Missing environment variable: COUNTER_HANDLE_f1709696");
  }
