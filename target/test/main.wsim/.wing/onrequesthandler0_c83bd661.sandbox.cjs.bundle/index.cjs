...
var require_inflight_Closure3_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure3-1.cjs"(exports2, module2) {
    ...
    module2.exports = function({ $__parent_this_3_api_url }) {
      class $Closure3 {
        static {
...
// target/test/main.wsim/.wing/onrequesthandler0_c83bd661.sandbox.cjs
var $handler = void 0;
    ...
    const $ctx = {
      handler: await (async () => {
        const $Closure3Client = require_inflight_Closure3_1()({
          $__parent_this_3_api_url: process.env["WING_TOKEN_WSIM_ROOT_ENV0_A_API_ATTRS_URL"]
        });
