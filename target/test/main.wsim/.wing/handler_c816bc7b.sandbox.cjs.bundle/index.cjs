...
var require_inflight_Closure3_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure3-1.cjs"(exports2, module2) {
    ...
    module2.exports = function({ $http_Util, $invokeAndAssert, $website_url }) {
      class $Closure3 {
        static {
...
var require_inflight_Closure2_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure2-1.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $expect_Util }) {
      class $Closure2 {
        static {
...
// target/test/main.wsim/.wing/handler_c816bc7b.sandbox.cjs
var $handler = void 0;
  ...
  $handler = $handler ?? await (async () => {
    const $Closure3Client = require_inflight_Closure3_1()({
      ...
      $invokeAndAssert: await (async () => {
        ...
        const client2 = new $Closure2Client({});
