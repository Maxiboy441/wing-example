...
var require_inflight_Closure1_1 = __commonJS({
  "target/main.wsim/.wing/inflight.$Closure1-1.cjs"(exports2, module2) {
    ...
    module2.exports = function({ $redis }) {
      class $Closure1 {
        static {
    ...
    const $ctx = {
      handler: await (async () => {
        const $Closure1Client = require_inflight_Closure1_1()({
          $redis: function() {
            let handle = process.env.REDIS_HANDLE_0ef75afb;
            if (!handle) {
              throw new Error("Missing environment variable: REDIS_HANDLE_0ef75afb");
            }
